...
INSERT INTO racer VALUES(sqRacer.NEXTVAL, 'Jokurt Karin','0', null);  
INSERT INTO racer VALUES(sqRacer.NEXTVAL, 'Nakurt Norbert','1', null);
INSERT INTO racer VALUES(sqRacer.NEXTVAL, 'Jokurt Kerstin','0', null);
INSERT INTO racer VALUES(sqRacer.NEXTVAL, 'Kernstein Susi','0', null);
INSERT INTO racer VALUES(sqRacer.NEXTVAL, 'Weinstein Werner','1', null);
INSERT INTO racer VALUES(sqRacer.NEXTVAL, 'Obersteiner Annalena','0', null);
...
inner join race on race.id = participation.idrace
where idrace = 3 and lower(racetype) = 'quarter';

select * from (select ROW_NUMBER() OVER(
    ORDER BY racertime ASC
) row_num, idrace, idracer, racertime from participation 
where idrace in (
    select id from race where id in (
        select idRace from participation where idRacer = 3
    )
) and lower(racetype) = 'full'
) where idracer = 3
